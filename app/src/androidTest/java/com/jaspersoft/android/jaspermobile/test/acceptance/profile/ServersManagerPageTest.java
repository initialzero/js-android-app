...
import static com.jaspersoft.android.jaspermobile.test.acceptance.profile.DummyServerProfile.queryCreatedProfile;
...
public class ServersManagerPageTest extends ProtoActivityInstrumentation<ServersManagerActivity_> {
    ...
    public void testValidFormCreation() {
        ...
        onView(withId(R.id.aliasEdit)).perform(typeText(DummyServerProfile.TEST_ALIAS));
        onView(withId(R.id.serverUrlEdit)).perform(typeText(DummyServerProfile.TEST_SERVER_URL));
        onView(withId(R.id.organizationEdit)).perform(typeText(DummyServerProfile.TEST_ORGANIZATION));
        onView(withId(R.id.usernameEdit)).perform(typeText(DummyServerProfile.TEST_USERNAME));
        onView(withId(R.id.passwordEdit)).perform(typeText(DummyServerProfile.TEST_PASS));
        ...
        onOverflowView(getActivity(), withText(getActivity()
                .getString(R.string.spm_profile_created_toast, DummyServerProfile.TEST_ALIAS)))

  ...
  define('js.mobile.amber2.dashboard.controller', ['require','jquery','js.mobile.lifecycle','js.mobile.module'],function(require) {
    ...
    return DashboardController = (function(superClass) {
      ...
      function DashboardController(options) {
        ...
        this.context = options.context, this.session = options.session, this.uri = options.uri, this.scaler = options.scaler;
...
(function() {
  define('js.mobile.amber2.android.dashboard.client', ['require','js.mobile.android.logger','js.mobile.context','js.mobile.amber2.dashboard','js.mobile.android.dashboard.callback'],function(require) {
    var AndroidLogger, Context, DashboardCallback, DashboardClient, MobileDashboard;
...
(function() {
  require(['js.mobile.amber2.android.dashboard.client'], function(DashboardClient) {
    return new DashboardClient().run();
  });

}).call(this);

define("android/amber2/dashboard/main.js", function(){});

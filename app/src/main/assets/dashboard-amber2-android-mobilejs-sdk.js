...
(function() {
  ...
  define('js.mobile.amber2.dashboard.controller', ['require','jquery','js.mobile.lifecycle','js.mobile.module'],function(require) {
    var $, DashboardController, Module, lifecycle;
    $ = require('jquery');
    ...
    return DashboardController = (function(superClass) {
      ...
      function DashboardController(options) {
        ...
        this.callback = options.callback, this.session = options.session, this.uri = options.uri, this.scaler = options.scaler;
      ...
      DashboardController.prototype._scaleDashboard = function() {
        ...
        return $('#container').addClass('scaledCanvas');
      };
...
(function() {
  define('js.mobile.dashboard.scaler', [],function() {
    var DashboardScaler;
    return DashboardScaler = (function() {
      function DashboardScaler(options) {
        this.diagonal = options.diagonal;
      }

      DashboardScaler.prototype.initialize = function() {
        var factor;
        factor = this._calculateFactor();
        return this._generateStyles(factor);
      };

      DashboardScaler.prototype._calculateFactor = function() {
        return this.diagonal / 10.1;
      };

      DashboardScaler.prototype._generateStyles = function(factor) {
...
(function() {
  ...
  define('js.mobile.amber2.dashboard', ['require','js.mobile.amber2.dashboard.controller','js.mobile.session','js.mobile.dashboard.scaler','js.mobile.lifecycle','js.mobile.module'],function(require) {
    ...
    MobileDashboard = (function(superClass) {
      ...
      MobileDashboard.refresh = function() {
        return this._instance._refresh();
      };
      ...
      MobileDashboard.prototype._run = function(options) {
        options.session = this.session;
        options.callback = this.args.callback;
        options.scaler = new Scaler(options);
        this._controller = new DashboardController(options);
        return this._controller.runDashboard();
      };

      MobileDashboard.prototype._destroy = function() {
      ...
      MobileDashboard.prototype._refreshDashlet = function() {
        return this._controller.refreshDashlet();
      };

      MobileDashboard.prototype._refresh = function() {
...
(function() {
  define('js.mobile.amber2.android.dashboard.client', ['require','js.mobile.amber2.dashboard','js.mobile.android.dashboard.callback'],function(require) {
    var DashboardCallback, DashboardClient, MobileDashboard;
    MobileDashboard = require('js.mobile.amber2.dashboard');
    DashboardCallback = require('js.mobile.android.dashboard.callback');
    return DashboardClient = (function() {
      function DashboardClient() {}

      DashboardClient.prototype.run = function() {

  ...
  define('js.mobile.amber2.dashboard.controller', ['require','jquery','js.mobile.lifecycle','js.mobile.module'],function(require) {
    ...
    return DashboardController = (function(superClass) {
      ...
      DashboardController.prototype._executeDashboard = function(v) {
        var processSuccess;
        this.v = v;
        processSuccess = this._processSuccess;
        return this.dashboard = this.v.dashboard({
          report: {
            chart: {
              animation: false,
              zoom: false
      ...
      DashboardController.prototype._processSuccess = function(dashboard) {
...
(function() {
  define('js.mobile.amber2.android.dashboard.client', ['require','js.mobile.amber2.dashboard','js.mobile.android.dashboard.callback','js.mobile.android.scale.style.dashboard'],function(require) {
    var DashboardCallback, DashboardClient, MobileDashboard, ScaleStyleDashboard;

...
(function() {
  ...
  define('js.mobile.report.controller', ['require','jquery'],function(reqiure) {
    var ReportController, jQuery;
    ...
    return ReportController = (function() {
      ...
      ReportController.prototype._processSuccess = function(parameters) {
        this.logger.log(JSON.stringify(parameters));
        if (parameters.components.length === 0) {
          return this.callback.onEmptyReportEvent();
        } else {
  ...
  define('js.mobile.report', ['require','js.mobile.session','js.mobile.report.controller'],function(require) {
    ...
    MobileReport = (function() {
      ...
      MobileReport.prototype._applyReportParams = function(params) {
        return this.reportController.applyReportParams(params);
      };

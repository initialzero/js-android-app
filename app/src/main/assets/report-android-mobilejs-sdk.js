  ...
  define('js.mobile.android.report.callback', ['require','js.mobile.callback_dispatcher'],function(require) {
    ...
    return ReportCallback = (function(superClass) {
      ...
      ReportCallback.prototype.onTotalPagesLoaded = function(pages) {
        this.dispatch(function() {
          return Android.onTotalPagesLoaded(pages);
        });
      };
  ...
  define('js.mobile.report.controller', ['require','jquery','js.mobile.lifecycle','js.mobile.module'],function(reqiure) {
    ...
    return ReportController = (function(superClass) {
      ...
      ReportController.prototype.selectPage = function(page) {
        if (this.report != null) {
          return this.report.pages(page).run().done(this._processSuccess).fail(this._processErrors);
        }
      };
      ...
      ReportController.prototype._loadPage = function(page) {
        return this.report.pages(page).run().fail(this._processErrors).done(this._notifyPageChange);
      };
      ...
      ReportController.prototype._getServerVersion = function(callback) {
        ...
        return jQuery.ajax(window.location.href + "/rest_v2/serverInfo", {
          dataType: 'json'
        }).done((function(_this) {
          return function(response) {
            var version;
            version = _this._parseServerVersion(response);
            _this.logger.log("Server version: " + version);

...
(function() {
  ...
  define('js.mobile.android.report.callback', ['require','js.mobile.callback_dispatcher'],function(require) {
    var CallbackDispatcher, ReportCallback;
    ...
    return ReportCallback = (function(superClass) {
      ...
      ReportCallback.prototype.onLoadDone = function(parameters) {
        this.dispatch(function() {
          return Android.onLoadDone(parameters);
        });
      };
      ...
      ReportCallback.prototype.onRefreshSuccess = function() {
        this.dispatch(function() {
          return Android.onRefreshSuccess();
        });
      };

      ReportCallback.prototype.onRefreshError = function(error) {
        this.dispatch(function() {
          return Android.onRefreshError(error);
        });
      };
...
(function() {
  ...
  define('js.mobile.report.controller', ['require','jquery','js.mobile.lifecycle','js.mobile.module'],function(reqiure) {
    var Module, ReportController, jQuery, lifecycle;
    jQuery = require('jquery');
    lifecycle = require('js.mobile.lifecycle');
    Module = require('js.mobile.module');
    return ReportController = (function(superClass) {
      ...
      function ReportController(options) {
        ...
        this.callback = options.callback, this.uri = options.uri, this.session = options.session, this.params = options.params, this.pages = options.pages;
      ...
      ReportController.prototype._runReportOnTheVersionBasis = function(version) {
        ...
        if (isAmber2orHigher) {
          ...
          return this._runReportWithoutAuthButWithHack();
        }
      };
      ...
      ReportController.prototype._loadPage = function(page) {
        return this.report.pages(page).run().fail(this).done(this._notifyPageChange);
      };
        ...
        params = {
          ...
          success: (function(_this) {
            return function(response) {
              var version;
              version = _this._parseServerVersion(response);
              return callback.call(_this, version);
            };
          })(this),
      ...
      ReportController.prototype._parseServerVersion = function(response) {
        var digit, digits, i, index, len, result, serverVersion;
        serverVersion = response.version;
        digits = serverVersion.match(/\d/g);
        result = 0;
        for (index = i = 0, len = digits.length; i < len; index = ++i) {
          digit = digits[index];
...
(function() {
  ...
  define('js.mobile.report', ['require','js.mobile.session','js.mobile.report.controller','js.mobile.lifecycle','js.mobile.module'],function(require) {
    ...
    MobileReport = (function(superClass) {
      extend(MobileReport, superClass);

      MobileReport.include(lifecycle.report.instanceMethods);

      MobileReport.extend(lifecycle.report.staticMethods);
      ...
      MobileReport.applyReportParams = function(params) {
        return this._instance._applyReportParams(params);
      };

      function MobileReport(args1) {
        this.args = args1;
      ...
      MobileReport.prototype._selectPage = function(page) {
        if (this._controller) {
          return this._controller.selectPage(page);
        }
      };

      MobileReport.prototype._exportReport = function(format) {
        return this._controller.exportReport(format);
      };

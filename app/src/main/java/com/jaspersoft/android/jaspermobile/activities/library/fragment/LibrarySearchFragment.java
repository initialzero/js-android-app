...
public class LibrarySearchFragment extends RoboFragment implements SearchView.OnQueryTextListener {

    public static final String TAG = LibrarySearchFragment.class.getSimpleName();

 ...
 */
public abstract class AbstractUseCase<Result> implements UseCase<Result> {

    private Subscription subscription = Subscriptions.empty();

    /**
     * Builds an {@link rx.Observable} which will be used when executing the current {@link AbstractUseCase}.
     */

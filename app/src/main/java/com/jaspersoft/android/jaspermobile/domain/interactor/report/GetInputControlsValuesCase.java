 ...
 */
@PerProfile
public class GetInputControlsValuesCase extends AbstractUseCase<List<InputControlState>, String> {
    private final ControlsRepository mControlsRepository;

    @Inject
    public GetInputControlsValuesCase(
    ...
    protected Observable<List<InputControlState>> buildUseCaseObservable(String reportUri) {
        return mControlsRepository.listControlValues(reportUri);
    }
}

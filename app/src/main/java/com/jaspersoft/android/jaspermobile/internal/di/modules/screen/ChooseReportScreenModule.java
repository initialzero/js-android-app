...
import com.jaspersoft.android.jaspermobile.data.fetchers.ResourcesFetcher;
import com.jaspersoft.android.jaspermobile.data.fetchers.ThumbnailFetcherImpl;
import com.jaspersoft.android.jaspermobile.data.model.JasperResourceModelImpl;
 ...
 */
@Module
public class ChooseReportScreenModule {

    @Provides
    @PerScreen
    CatalogFetcher providesCatalogLoader(ResourcesFetcher fetcher) {
        return fetcher;
    }
    ...
    @Provides
    @PerScreen
    JasperResourceModel provideJasperResourceModel(JasperResourceModelImpl model) {
        return model;
    }

    @Provides
    @PerScreen
    ResourceModel provideResourceModel(JasperResourceModelImpl model) {
        return model;
    }
}

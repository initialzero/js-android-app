 ...
 * @since 1.9
 */
class ExceptionLogStrategy {

    private static final String TAG = RequestExceptionHandler.class.getSimpleName();

    private ExceptionLogStrategy() {
    }

    public static void log(Exception exception, Activity activity, String message) {
        boolean qaBuild = BuildConfig.FLAVOR.equals("qa");
        if (qaBuild) {

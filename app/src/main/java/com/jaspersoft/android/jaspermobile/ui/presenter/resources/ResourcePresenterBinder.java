 ...
 * @since 2.3
 */
public abstract class ResourcePresenterBinder<RT extends Resource, VH extends ResourceViewHolder, RM extends ResourceModel> {

    public abstract void bind(VH holder, RT entity, RM model);
}

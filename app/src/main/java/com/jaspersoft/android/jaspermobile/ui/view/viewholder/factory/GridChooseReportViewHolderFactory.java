 ...
 */
@PerActivity
public class GridChooseReportViewHolderFactory extends GridResourceViewHolderFactory<JasperResource, JasperResourceViewHolder> {

    @Inject
    public GridChooseReportViewHolderFactory(@ActivityContext Context mContext) {
        super(mContext);
    }

    @Override
    protected int getHolderIdInternal(JasperResource resource) {
        throw new UnsupportedOperationException("Grid representation is not supported for choose report");
    }

 ...
 * @since 2.3
 */
public abstract class ListResourceViewHolderFactory<RT extends Resource, ViewHolder extends ResourceViewHolder> extends ResourceViewHolderFactory<RT, ViewHolder> {

    public ListResourceViewHolderFactory(Context mContext) {
        super(mContext);
    }
}

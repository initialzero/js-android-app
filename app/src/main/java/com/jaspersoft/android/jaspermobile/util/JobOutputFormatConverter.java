...
public class JobOutputFormatConverter {
    ...
    public static String[] toStringsArray(Context context, List<JobOutputFormat> jobOutputFormatList) {
        ...
        for (int i = 0; i < jobOutputFormatList.size(); i++) {
            titles[i] = formatToString(context, jobOutputFormatList.get(i));
        }

        return titles;
    }

    private static String formatToString(Context context, JobOutputFormat jobOutputFormat) {

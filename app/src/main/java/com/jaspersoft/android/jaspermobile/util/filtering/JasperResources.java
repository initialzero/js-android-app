...
public class JasperResources {
    ...
    public static ArrayList<String> dashboard(ServerVersion serverVersion) {
        boolean isPreAmber = serverVersion.getVersionCode() < ServerVersion.AMBER.getVersionCode();
        if (isPreAmber) {

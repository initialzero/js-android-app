 ...
 * @since 2.1
 */
final class AmberExportIdFormat implements ExportIdFormat {
    private final ExportsRequest exportsRequest;

    AmberExportIdFormat(ExportsRequest exportsRequest) {
        this.exportsRequest = exportsRequest;
    }

    @Override
    public String format() {
        return String.format("%s;pages=%s", exportsRequest.getOutputFormat(), exportsRequest.getPages());
    }
}

...
public class AccountDataMapperTest {
    ...
    public void setUp() throws Exception {
        mapper = new AccountDataMapper("com.jaspersoft");
    }

    @Test
    public void testTransform() throws Exception {
        Account account = mapper.transform(Profile.create("alias"));
        assertThat(account.name, is("alias"));
        assertThat(account.type, is("com.jaspersoft"));
    }
}